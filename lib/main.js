...
export default {
  config: {
    ...
    checkRequiredVar: {
      ...
      type: 'boolean',
      description: 'Check whether all required variables have been specified (unchecking is useful if primarily developing/declaring modules).',
      default: true
    }
  },
  ...
  provideLinter() {
    return {
      ...
      lint: (activeEditor) => {
        ...
        if (!(atom.config.get('linter-terraform-syntax.checkRequiredVar')))
