  ...
  provideLinter() {
    return {
      ...
      lint: (activeEditor) => {
        ...
        // initialize stream since it is stdout normally
        var istream = 'stderr'
        ...
        return helpers.exec(atom.config.get('linter-terraform-syntax.terraformExecutablePath'), args, {cwd: dir, stream: istream, allowEmptyStderr: true}).then(output => {
          var toReturn = [];
