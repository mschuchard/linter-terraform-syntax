...
export default {
  config: {
    ...
    globalVarFiles: {
      ...
      type: 'array',
      description: 'Var files specified by absolute paths that should be applied to all projects. (< 0.12)',
      default: [''],
      items: {
        type: 'string'
      }
    ...
    localVarFiles: {
      ...
      type: 'array',
      description: 'Var files specified by relative paths to each project that should be applied. If these files are not in the same relative path within each project this will fail. (< 0.12)',
      default: [''],
      items: {
        type: 'string'
      }
