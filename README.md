...
- Support for Terraform >= 0.12 is currently provided as a beta feature. You will need to check the config setting for it. Note that only `validate` linting functionality changes in >= 0.12.
